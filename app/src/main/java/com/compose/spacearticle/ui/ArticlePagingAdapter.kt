...
class ArticlePagingAdapter: PagingDataAdapter<Article, ArticlePagingAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    class ViewHolder(private val binding: ArticleItemBinding, private val onItemClick: ((Article) -> Unit)?): RecyclerView.ViewHolder(binding.root){
